    ...
    <div class="container-custom">
      ...
      <div class="content-wrapper">
        ...
        <main class="bikes-container">
          ...
          <div v-else-if="bikeStore.error" class="no-results">
            <p>⚠️</p>
            <h3>Couldn't load bikes</h3>
            <p>{{ bikeStore.error }}</p>
            <button type="button" class="mobile-filter-toggle" style="display:inline-flex; margin-top:1rem;" @click="bikeStore.fetchBikes()">Retry</button>
          </div>
